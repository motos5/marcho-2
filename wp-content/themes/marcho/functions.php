...
function marcho_scripts() {
	...
	wp_enqueue_style( 'marcho-slick-css', get_template_directory_uri() . '/assets/slick-carousel/slick/slick.css', array(), _S_VERSION );
	wp_enqueue_style( 'marcho-style-main', get_template_directory_uri() . '/assets/css/frontend/style.min.css', array(), _S_VERSION );

	// Scripts
	wp_enqueue_script('jquery');
	wp_enqueue_script( 'marcho-slick-js', get_template_directory_uri() . '/assets/slick-carousel/slick/slick.min.js', array(), _S_VERSION, true );
